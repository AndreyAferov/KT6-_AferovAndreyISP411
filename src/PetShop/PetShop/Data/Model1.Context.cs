...
namespace PetShop.Data
{
    ...
    public partial class TradesEntities : DbContext
    {
        public static TradesEntities _context;
        public static TradesEntities GetContext()
        {
            if (_context == null)
            {
                _context = new TradesEntities();
            }
            return _context;
        }
        public TradesEntities()
            : base("name=TradesEntities")
        {
        }
